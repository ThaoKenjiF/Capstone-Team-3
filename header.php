    ...
    <div class="col-lg-12 ">
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success" href="filter_apptmemployee.php" role="button">Approvals assigned to terminated
                    employee</a>
                    <a class="btn btn-success" href="active_employee.php" role="button">Active Employee</a>
                 
                <?php   if ($_SESSION['role'] == "IT"){
      echo '<a class="btn btn-success" href="filter_appr_obsolete.php" role="button">Approvals tied to absolete parts</a>';
    }
    ?>
