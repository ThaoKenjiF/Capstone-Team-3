...
$sql = "SELECT * FROM approval_routing INNER JOIN inventory_part ON approval_routing.id = inventory_part.id WHERE key_ref LIKE '%PART!_NO%'ESCAPE '!' AND inventory_part.part_status = 'O'";
